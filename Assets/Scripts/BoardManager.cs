...
public class BoardManager : MonoBehaviour 
{
	...
	private void SelectChessman (int x, int y)
	{
		...
		if (Chessmans [x, y].isWhite != isWhiteTrue)
			return;
	...
	private void MoveChessman(int x, int y)
	{
		if (allowedMoves [x, y])
		{
			...
			if (c != null && c.isWhite != isWhiteTrue) 
			{
				//Capture a piece
	...
	{
		GameObject go = Instantiate (chessmanPrefabs [index], GetTitleCenter(x, y), orientation) as GameObject;
